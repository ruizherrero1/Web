  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`fixed bottom-6 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--wc-accent)] text-[var(--wc-accent-fg)] shadow-lg transition-all duration-300 ${
