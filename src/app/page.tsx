...
export default function Home() {
  return (
    <>
      <Hero />
      <section className="border-y border-[var(--line)] bg-[var(--surface-strong)] py-14">
        <div className="container-shell">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {areas.map(({ label, Icon }) => (
              <div
                className="reveal flex items-center gap-3 rounded-lg border border-[var(--line)] bg-[var(--surface)] p-4 text-sm font-semibold text-[var(--ink)] shadow-sm transition hover:border-[var(--accent)] hover:shadow-md"
                key={label}
              >
      ...
      <section className="reveal bg-[var(--navy)] py-14 text-white">
