...
GuÃƒÂ­a para desplegar la web en Vercel y conectarla con `ramonruizherrero.com`.
...
- Si Vercel recomienda modo DNS only para algÃƒÂºn registro, documentarlo antes de cambiarlo.

## Checklist antes de deploy

- `npm run build` sin errores.
- Enlaces TODO revisados.
- No hay datos sensibles en el cÃƒÂ³digo.
...
- `ROTTENTOMATO_RAPIDAPI_KEY`: clave privada de RapidAPI para Rotten Tomatoes.
- `CINE_RT_SYNC_LIMIT`: opcional; maximo de titulos a consultar en Rotten Tomatoes por actualizacion. Por defecto 25.
